    ...
    if (videos && videos.length > 0 && videos[0]) {
      const urlElement = videos[0].url;
       ...
       let infoMess = {
         ...
         caption : `\n⬡CHASE AND BADBOI bot song downloader📂\n\n*song name : _${videos[0].title}_
...
_┃CHASE AND BADBOI  bot is downloading your file📂┃_\n\n`
       }
...
zokou({
  ...
  try {
    ...
    if (videos && videos.length > 0 && videos[0]) {
      ...
      let InfoMess = {
        image: { url: videos[0].thumbnail },
        caption: `⬡CHASE AND BADBOI bot song downloader📂\n\nVideo name : _${Element.title}_
Time : _${Element.timestamp}_
Url : _${Element.url}_
_\n┃CHASE AND BADBOI bot is downloading your file📂┃_\n\n`
      };
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "┃generated by CHASE bot┃", gifPlayback: false }, { quoted: ms });
      });
